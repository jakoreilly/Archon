...
The packaged `archon-analysis-0.2.9.vsix` is self-contained and can be shared directly. Install it
with `code --install-extension archon-analysis-0.2.9.vsix`, or through
